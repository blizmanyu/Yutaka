...
namespace Yutaka.Tests
{
	static class Program
	{
		...
		private static void Test_Top1000GirlNames()
		{
			...
			if (Top1000GirlNames.Exists(x => test.Contains(x))) {
				Console.Write("\n\nMatch!");
			}
