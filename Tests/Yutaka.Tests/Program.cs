...
namespace Yutaka.Tests
{
	static class Program
	{
		...
		private static void Test_YuImage()
		{
			...
			consoleOut = !deleteFile;
			var source = @"E:\Backups\From Sony Vaio 2015 1225 1532\SkyDrive\Pictures\";
			var dest = @"G:\Images\";
			//var source = @"G:\Images\";
			//var dest = @"G:\Pictures\";
