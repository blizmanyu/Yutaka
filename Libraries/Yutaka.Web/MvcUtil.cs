	...
	public static class MvcUtil
	{
		...
		public static bool IsBot()
		{
			try {
				...
				throw new Exception(String.Format("Exception thrown in MvcUtil.IsBot(){2}{0}{2}{2}{1}", ex.Message, ex.ToString(), Environment.NewLine));
			}
		}
		...
		public static bool IsBot(string userAgent)
		{
			...
			try {
				...
				throw new Exception(String.Format("Exception thrown in MvcUtil.IsBot(string userAgent='{3}'){2}{0}{2}{2}{1}", ex.Message, ex.ToString(), Environment.NewLine, userAgent));
			}
		}
