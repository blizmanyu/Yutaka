...
namespace Yutaka.Web
{
	public static class WebUtil
    {
		...
		private static HttpContext CurHttpContext = HttpContext.Current;
		private static HttpSessionState Session = CurHttpContext.Session;
		private static HttpRequest Request = CurHttpContext.Request;
		...
		public static void SetSessionVariables()
		{
			if (CurHttpContext == null)
				CurHttpContext = HttpContext.Current;
			if (Session == null)
				Session = CurHttpContext.Session;
			if (Request == null)
				Request = CurHttpContext.Request;
