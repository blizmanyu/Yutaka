...
namespace Yutaka.IO
{
	public class YuImage
	{
		...
		public DateTime OldDate = DateTime.Now.AddYears(-7);
		public string[] Apps = new string[] { "Messenger", "Cash App", "Facebook", "Messages", "WhatsApp", "Bitmoji", "CashApp", "Netflix", "Pandora", "Samsung", "Spotify", "Twitter", "YouTube", "Amazon", "Chrome", "TikTok", "Bixby", "Gmail", "Sleep", "Line", "Maps", "Turo", "Uber", };
		public string[] Documents = new string[] { "Consumer Reports", "ConsumerReports", "United Airlines", "UnitedAirlines", "Womens Health", "Confirmation", "Registration", "WomensHealth", "Itineraries", "Mens Health", "Green Card", "Maximum PC", "MensHealth", "GreenCard", "Itinerary", "MaximumPC", "Thank You", "Checkout", "Invoices", "Passport", "PC Gamer", "Receipts", "ThankYou", "Invoice", "License", "PCGamer", "Receipt", "Welcome", "Thanks", "Chase", "Delta", "Maxim", "Scans", "ETNT", "FICO", "Ikea", "Scan", "GQ", };
		public string[] Games = new string[] { "Clash of Clans", "Clash Royale", "ClashOfClans", "ClashRoyale", "Castle Age", "CastleAge", "Fantasica", };
		...
		public string[] Zz = new string[] { "PreciousO23_Bucket", "Video Player", "DragonFruit", "Instagram", "Steamgirl", "Patricia", "Snapchat", "OkCupid", "P Shots", "Vanessa", "Bumble", "London", "Tinder", "Happn", "Sarah", "Leah", "Mely", "Olga", };
