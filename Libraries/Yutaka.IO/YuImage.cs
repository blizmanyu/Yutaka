...
namespace Yutaka.IO
{
	public class YuImage
	{
		...
		public string[] Apps = new string[] { "Messenger", "Cash App", "Facebook", "Messages", "WhatsApp", "Bitmoji", "CashApp", "Netflix", "Pandora", "Samsung", "Spotify", "Twitter", "YouTube", "Amazon", "Chrome", "TikTok", "Bixby", "Gmail", "Sleep", "Line", "Maps", "Turo", "Uber", "Apps", };
		public string[] Documents = new string[] { "Consumer Reports", "ConsumerReports", "United Airlines", "UnitedAirlines", "Womens Health", "Confirmation", "Registration", "WomensHealth", "Itineraries", "Mens Health", "Green Card", "Maximum PC", "MensHealth", "GreenCard", "Itinerary", "Magazines", "MaximumPC", "Thank You", "Checkout", "Invoices", "Magazine", "Passport", "PC Gamer", "Receipts", "ThankYou", "Invoice", "License", "PCGamer", "Receipt", "Welcome", "Thanks", "Chase", "Delta", "Maxim", "Scans", "ETNT", "FICO", "Ikea", "Scan", "Car", "GQ", "Documents", };
		public string[] Games = new string[] { "Clash of Clans", "Clash Royale", "ClashOfClans", "ClashRoyale", "Castle Age", "CastleAge", "Fantasica", "Games", };
		public string[] MeList = new string[] { "zMe", "Me", };
		public string[] Special = new string[] { "Philips Hue", "PhilipsHue", "Grooming", "Unsplash", "Tattoos", "Nanami", "Shirts", "Tattoo", "Poses", "Shirt", "Pose", };
		public string[] Zz = new string[] { "PreciousO23_Bucket", "Video Player", "DragonFruit", "Instagram", "Steamgirl", "Patricia", "Snapchat", "OkCupid", "P Shots", "Vanessa", "Bumble", "London", "Tinder", "Happn", "Sarah", "Leah", "Mely", "Olga", "Zz", };
		...
		private void SetNewFolderAndFilename()
		{
			...
			for (int i = 0; i < Apps.Length; i++) {
				if (Regex.IsMatch(FullName, String.Format(@"[^a-zA-Z]{0}[^a-zA-Z]", Apps[i]), RegexOptions.IgnoreCase)) {
					if (Apps[i].Equals("Apps")) {
						if (ParentFolder.Equals("Apps"))
							NewFolder = @"Apps\";
						else
							NewFolder = String.Format(@"Apps\{0}\", ParentFolder);
					}

					else
						NewFolder = String.Format(@"Apps\{0}\", Apps[i]);
