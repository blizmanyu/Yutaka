...
namespace Yutaka.IO
{
	public class YuImage
	{
		...
		public string[] Apps = new string[] { "YouTube", "Instagram", "Snapchat", "Messenger", "Facebook", "Bitmoji", "Netflix", "Maps", "Gmail", "Spotify", "Amazon", "Uber", "WhatsApp", "Pandora", "TikTok", "Cash App", "CashApp", "Chrome", "Twitter", };
		public string[] Documents = new string[] { "asdfsadf", };
		public string[] Games = new string[] { "asdfsadf", };
		public string[] Music = new string[] { "asdfsadf", };
