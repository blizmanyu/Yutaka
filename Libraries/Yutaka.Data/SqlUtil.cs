...
namespace Yutaka.Data
{
	public class SqlUtil
	{
		...
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_CloseConnection = CommandBehavior.CloseConnection;
		/// <summary>
		...
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_Default = CommandBehavior.Default;
		/// <summary>
		...
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_KeyInfo = CommandBehavior.KeyInfo;
		/// <summary>
		...
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_SchemaOnly = CommandBehavior.SchemaOnly;
		/// <summary>
		/// Provides a way for the DataReader to handle rows that contain columns with large binary values. Rather than loading the entire row, SequentialAccess enables the DataReader to load data as a stream. You can then use the GetBytes or GetChars method to specify a byte location to start the read operation, and a limited buffer size for the data being returned.
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_SequentialAccess = CommandBehavior.SequentialAccess;
		/// <summary>
		/// The query returns a single result set.
		/// </summary>
		public static readonly CommandBehavior CommandBehavior_SingleResult = CommandBehavior.SingleResult;
		/// <summary>
