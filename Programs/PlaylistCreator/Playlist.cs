...
namespace PlaylistCreator
{
	public class Playlist
	{
		...
		public List<SongFileInfo> GoodEnglishSongs = new List<SongFileInfo> {
			...
			new SongFileInfo("Billie Eilish", "Lovely (Hippie Sabotage Remix)"),
			new SongFileInfo("Dashboard Confessional", "Hands Down (Acoustic)"),
			new SongFileInfo("Ed Sheeran", "Dive"),
			new SongFileInfo("Ed Sheeran", "Perfect"),
			new SongFileInfo("Ed Sheeran", "Photograph"),
			new SongFileInfo("Ed Sheeran", "Shape of You"),
			new SongFileInfo("Ed Sheeran", "Shiver"),
			new SongFileInfo("Ed Sheeran", "Thinking out Loud"),
			...
			new SongFileInfo("Radiohead", "Creep"),
